...
declare module 'motia' {
  ...
  interface Handlers {
    ...
    'signup': ApiRouteHandler<{ name: string; email: string; password: string; monthly_budget?: number }, ApiResponse<200, { token: string; user: { id: number; name: string; email: string } }> | ApiResponse<400, { message: string }> | ApiResponse<500, { message: string; error: string }>, { topic: 'notification'; data: { templateId: string; email: string; templateData: Record<string, unknown> } }>
  }
}